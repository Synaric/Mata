...
public abstract class BaseManagedFragment extends SupportFragment {
    ...
    public void startFragment(BaseManagedFragment fragment) {
        startFragment(fragment, SupportFragment.STANDARD);
    }

    public void startFragment(BaseManagedFragment fragment, int launchMode) {
        BaseManagedFragment parent = (BaseManagedFragment) getParentFragment();
        if(parent == null) {
    ...
    public void startFragmentSingleTask(
            ...
            Class<? extends BaseManagedFragment> to,
            boolean post) {

        BaseManagedFragment fragment = findFragment(to);
        if (fragment == null) {
            popTo(from, false, () -> {
                try {
                    if (post) {
    ...
    public void postStartFragment(Class<? extends BaseManagedFragment> from, SupportFragment to, int launchMode) {
